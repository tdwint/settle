...
export const metadata: Metadata = {
  title: { absolute: 'Invoice App for Electricians — Residential, Commercial & Service — Settle' },
  description: 'Stop waiting on checks to clear. Settle lets electricians invoice clients on the job and get paid by card in minutes. Free to start.',
  alternates: { canonical: 'https://gigpay.today/electricians' },
  openGraph: {
    title: 'Invoice App for Electricians — Settle',
    description: 'Stop waiting on checks to clear. Invoice on the job and get paid by card in minutes.',
    type: 'website',
  },
}

const services = [
  { emoji: '🏠', title: 'Residential Wiring', desc: 'New construction, rewires, and additions. Bill materials and labor on completion.' },
  { emoji: '⚡', title: 'Panel Upgrades', desc: 'Service upgrades, subpanels, and load center work. Invoice before you close the cover.' },
  { emoji: '🏢', title: 'Commercial Work', desc: 'Office buildings, retail, and industrial. Progress billing for larger projects.' },
  { emoji: '🚗', title: 'EV Charger Installs', desc: 'Level 2 home and commercial charger installations. Quick, professional invoices.' },
  { emoji: '🚨', title: 'Emergency Calls', desc: 'Outages, tripped breakers, and after-hours repairs. Invoice and collect on the spot.' },
  { emoji: '🔍', title: 'Inspections', desc: 'Code compliance, pre-purchase, and safety inspections. Bill per report or hour.' },
  { emoji: '💡', title: 'Lighting & Fixtures', desc: 'Recessed lights, fans, and fixture installs. Flat rate or hourly — your call.' },
  { emoji: '🏡', title: 'Smart Home', desc: 'Whole-home automation, networking, and smart panel work. Modern billing for modern jobs.' },
]
    ...
    <div className="min-h-screen font-sans" style={{backgroundColor:'#f8fafc'}}>
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-24 pb-32">
          <div className="max-w-2xl">
            ...
            <h1 className="font-display leading-tight mb-6" style={{fontSize:'clamp(2.2rem, 5vw, 4rem)', color:'#ffffff', letterSpacing:'-0.03em', lineHeight:'1.05'}}>
              Wire it up.<br />
              <span style={{color:'#fbbf24'}}>Get paid</span> on the job.
            </h1>

            <p className="text-lg leading-relaxed max-w-xl mb-10" style={{color:'rgba(148,163,184,0.9)'}}>
              Whether it's a panel upgrade, an emergency call, or a commercial build-out — stop waiting on checks in the mail. Send a professional invoice in 2 minutes and let clients pay by card before you leave the site.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link href="/blog/electricians-how-to-invoice-and-get-paid-faster" className="inline-flex items-center justify-center text-base font-medium px-7 py-3 rounded-xl transition-all" style={{background:'rgba(255,255,255,0.08)', border:'1px solid rgba(255,255,255,0.15)', color:'white'}}>
                Why it matters →
              </Link>
            </div>
          </div>
      ...
      <section className="py-10 border-b" style={{borderColor:'#e2e8f0'}}>
        <div className="max-w-6xl mx-auto px-6 text-center">
          <p className="text-xs font-semibold uppercase tracking-widest mb-5" style={{color:'#94a3b8'}}>For every kind of electrical work</p>
          <div className="flex items-center justify-center gap-8 flex-wrap">
            {['Residential Electricians', 'Commercial Electricians', 'Service Electricians', 'Industrial Electricians', 'Solar Installers', 'EV Specialists', 'Low-Voltage Techs', 'Electrical Contractors'].map(role => (
      ...
      <section className="py-24 max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-4xl mb-4" style={{color:'#0f172a'}}>Invoice for every service you run</h2>
          <p className="max-w-lg mx-auto" style={{color:'#64748b'}}>
            From a simple fixture swap to a full-panel upgrade — every material, hour, and service call deserves a professional invoice and fast payment in your account.
          </p>
        </div>
      ...
      <section className="py-24 border-y" style={{background:'rgba(15,13,56,0.02)', borderColor:'#e2e8f0'}}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl mb-4" style={{color:'#0f172a'}}>Close the panel and collect your money</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { step: '01', title: 'Build your invoice', desc: 'Add materials, labor, and any service fees. Itemize wire, breakers, and hours — every line item accounted for.' },
              { step: '02', title: 'Text the link', desc: 'Client gets a clean invoice on their phone. They pay by card immediately — no app, no hassle, no delay.' },
              { step: '03', title: 'Get paid, drive to the next job', desc: 'Instant email the second they pay. Your cash flow stays healthy and you stay focused on the work.' },
            ].map(({ step, title, desc }) => (
      ...
      <section className="pb-24 max-w-6xl mx-auto px-6">
        <div className="relative overflow-hidden rounded-3xl px-10 py-16 text-center" style={{background:'linear-gradient(135deg, #080720 0%, #1e1b6e 100%)'}}>
          ...
          <div className="relative">
            <h2 className="font-display text-4xl text-white mb-4">Power up your billing. Get paid faster.</h2>
