  ...
  offers: [
    {
      ...
      price: '0',
      priceCurrency: 'USD',
      description: '5 invoices per month, unlimited estimates, free forever',
    },
    {
      '@type': 'Offer',
      name: 'Pro Monthly',
      price: '12',
      priceCurrency: 'USD',
      description: 'Unlimited invoices and estimates, billed monthly',
    },
    {
      '@type': 'Offer',
      name: 'Pro Annual',
      price: '100',
      priceCurrency: 'USD',
      description: 'Unlimited invoices and estimates, billed annually',
    },
  ],
  aggregateRating: {
