...
export const metadata: Metadata = {
  title: { absolute: 'Invoice App for Photographers — Portraits, Weddings & Commercial — Settle' },
  description: 'Stop waiting weeks to get paid after a shoot. Settle lets photographers invoice clients professionally and get paid online in minutes. Free to start.',
  alternates: { canonical: 'https://gigpay.today/photographers' },
  openGraph: {
    title: 'Invoice App for Photographers — Settle',
    description: 'Stop waiting weeks to get paid after a shoot. Invoice professionally and get paid online in minutes.',
    type: 'website',
  },
}

const services = [
  { emoji: '💍', title: 'Wedding Photography', desc: 'Collect deposits and final payments. Invoice for packages, albums, and extras.' },
  { emoji: '📸', title: 'Portrait Sessions', desc: 'Headshots, family portraits, and lifestyle shoots. Bill per session or package.' },
  { emoji: '🏢', title: 'Commercial Work', desc: 'Brand, product, and corporate photography. Invoice by day rate or deliverable.' },
  { emoji: '🎉', title: 'Events & Parties', desc: 'Birthdays, corporate events, and galas. Send the invoice before you leave the venue.' },
  { emoji: '🏠', title: 'Real Estate', desc: 'Interior, exterior, and drone photography. Flat-fee invoicing that agents expect.' },
  { emoji: '🛍️', title: 'Product Photography', desc: 'E-commerce, catalog, and studio shoots. Bill per image count or day rate.' },
  { emoji: '📰', title: 'Editorial & Press', desc: 'Magazine, press, and journalism work. Track licensing and usage separately.' },
  { emoji: '🎨', title: 'Fine Art & Licensing', desc: 'Prints, licensing, and art sales. Keep a professional paper trail for every deal.' },
]
    ...
    <div className="min-h-screen font-sans" style={{backgroundColor:'#f8fafc'}}>
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-24 pb-32">
          <div className="max-w-2xl">
            ...
            <p className="text-lg leading-relaxed max-w-xl mb-10" style={{color:'rgba(148,163,184,0.9)'}}>
              Whether you shoot weddings, portraits, or commercial work — stop waiting weeks to get paid. Send a professional invoice in 2 minutes and let clients pay by card on the spot.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link href="/blog/photographers-guide-to-getting-paid" className="inline-flex items-center justify-center text-base font-medium px-7 py-3 rounded-xl transition-all" style={{background:'rgba(255,255,255,0.08)', border:'1px solid rgba(255,255,255,0.15)', color:'white'}}>
                Why it matters →
              </Link>
            </div>
          </div>
      ...
      <section className="py-10 border-b" style={{borderColor:'#e2e8f0'}}>
        <div className="max-w-6xl mx-auto px-6 text-center">
          <p className="text-xs font-semibold uppercase tracking-widest mb-5" style={{color:'#94a3b8'}}>For every kind of working photographer</p>
          <div className="flex items-center justify-center gap-8 flex-wrap">
            {['Wedding Photographers', 'Portrait Photographers', 'Commercial Photographers', 'Event Photographers', 'Real Estate Photographers', 'Product Photographers', 'Photojournalists', 'Fine Art Photographers'].map(role => (
      ...
      <section className="py-24 max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-xs font-semibold uppercase tracking-widest mb-3" style={{color:'#d97706'}}>Every shoot, properly invoiced</p>
          <h2 className="font-display text-4xl mb-4" style={{color:'#0f172a'}}>Invoice for every way you shoot</h2>
          <p className="max-w-lg mx-auto" style={{color:'#64748b'}}>
            From a single portrait session to a full wedding weekend — every shoot and service you deliver deserves a professional invoice and a fast payment.
          </p>
        </div>
      ...
      <section className="py-24 border-y" style={{background:'rgba(15,13,56,0.02)', borderColor:'#e2e8f0'}}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl mb-4" style={{color:'#0f172a'}}>Invoice before you pack up your gear</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { step: '01', title: 'Build your invoice', desc: 'Add your service, package, and rate. Session fees, travel, editing time — itemize exactly how you work.' },
              { step: '02', title: 'Send the link', desc: 'Your client gets a clean, professional invoice. Payable by card in seconds — no app needed on their end.' },
              { step: '03', title: 'Get notified instantly', desc: 'The moment they pay, you get an email. No chasing, no awkward follow-ups, no "I\'ll Venmo you later."' },
            ].map(({ step, title, desc }) => (
      ...
      <section className="pb-24 max-w-6xl mx-auto px-6">
        <div className="relative overflow-hidden rounded-3xl px-10 py-16 text-center" style={{background:'linear-gradient(135deg, #080720 0%, #1e1b6e 100%)'}}>
          ...
          <div className="relative">
            <h2 className="font-display text-4xl text-white mb-4">Your photography is a business. Invoice like one.</h2>
